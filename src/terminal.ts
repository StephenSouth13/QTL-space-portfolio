    ...
    document.addEventListener('keydown', (e) => {
        if (e.key === '`') {
            if (terminalContainer) {
                (terminalContainer as HTMLElement).style.display = 'flex';
                terminalInput.focus();
            }
        }
    });
        ...
        if (terminalOutput) {
            ...
            switch (command.toLowerCase()) {
                ...
                case 'play music':
                    ...
                    break;
                case 'launch ai':
                    const aiAssistant = document.querySelector('.ai-assistant') as HTMLElement;
                    if (aiAssistant) aiAssistant.classList.add('active');
                    break;
                case 'exit':
                    if (terminalContainer) (terminalContainer as HTMLElement).style.display = 'none';
                    break;
                default:
